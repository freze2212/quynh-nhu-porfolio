				...
				<div className="grid grid-cols-1 items-center justify-center justify-items-center gap-4 text-center sm:grid-cols-2">
					...
					<div>
						<h3 className="text-start text-gray-300 mb-3">
							...
							<b className="text-[#d6ae5b]">QUỲNH NHƯ</b> đã trở thành một biểu
							tượng của kiến thức, bản lĩnh và sự sang trọng. Với nhiều năm kinh
							nghiệm trong việc nghiên cứu và phân tích các dạng cầu, chị được biết
							đến như một chuyên gia hàng đầu, luôn mang đến những góc nhìn khoa
							học, dễ hiểu và áp dụng hiệu quả
							<br />
							<br />
							Điểm đặc biệt của <b className="text-[#d6ae5b]">QUỲNH NHƯ</b> là
							phong thái tự tin, bình tĩnh và tinh tế trong từng buổi chia sẻ. Chị
							không chỉ tập trung vào phân tích cầu Baccarat mà còn nhấn mạnh yếu
							tố giữ vững tâm lý, quản lý chiến lược – những kỹ năng then chốt giúp
							người chơi làm chủ cuộc chơi.
							<br />
							<br />
							👉 Chính vì vậy, <b className="text-[#d6ae5b]">QUỲNH NHƯ</b> không
							chỉ là một chuyên gia, mà còn là nguồn cảm hứng, dẫn dắt cộng đồng
							đến gần hơn với nghệ thuật Baccarat.
						</h3>
						...
						<div className="grid grid-cols-3 gap-4 mt-6">
							...
							<div className="border border-[#d6ae5b] rounded-lg text-center px-3 py-12">
								<div className="text-center">
									<ChartNoAxesCombined size={40} className="text-[#d6ae5b] m-auto" />
								</div>
								<p className="sm:text-lg text-sm font-medium text-center uppercase text-white/80 mt-2">
